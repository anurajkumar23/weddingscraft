...
interface CatererPageDataProps {
  data: CatererDocument[];
}

const CatererPage:React.FC<CatererPageDataProps> = async ({data}) => {

  const formattedCaterers: CatererColumn[] = data.map((item) => ({
    id: item._id,
    name: item.name,
