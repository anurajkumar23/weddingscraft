...
interface PhotographerPageDataProps {
  data: PhotographerDocument[];
}

const PhotographerPage:React.FC<PhotographerPageDataProps> = async ({data}) => {

  const formattedPhotographers: PhotographerColumn[] = data.map((item) => ({
