...
const MainCardPage: React.FC = () => {
    return (
        <div className='w-full h-full grid md:grid-cols-12 gap-2'>
                ...
                <div className=''>
                    ...
                    <div className='relative bottom-20 mx-4 bg-white rounded-sm p-4 shadow-xl border'>
                        ...
                        <div className="flex items-center mb-2">
                            ...
                            <div className='border text-[#FD001D] border-red-500 hover:bg-red-600 hover:text-white  ml-4 p-1 rounded-sm font-sans cursor-pointer'>
            ...
            <div className='border-2 rounded-sm md:col-span-4 p-2 pb-6 hidden md:block'>
             <Pricing id='Pricing'/>
            </div>
            <div className='md:col-span-8 '>
                <QuickInfo />
