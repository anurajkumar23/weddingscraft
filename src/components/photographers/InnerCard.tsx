    ...
    return (
        <div className="relative h-full w-full flex justify-center items-center ">
            <Link href={`/Photographers/${id}`}>
                <div className=" z-1 w-72 h-[420px] rounded-xl shadow-2xl text-white card-component border border-cyan-300 p-2 hover:border-cyan-400 hover:shadow-lg">
                    <div className="z-10 w-full absolute ">
                        ...
                        <div className="mt-4 mb-4 relative z-10 justify-center flex cursor-pointer">
                            <button className="rounded-full hover:bg-blue-500 p-2 px-3 bg-[#ed4ebb]">
                                Explore more
                            </button>
                        </div>
